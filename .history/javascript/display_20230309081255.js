...
payment.addEventListener("click", (e) => {
  ...
  document.querySelector('.confirm_grid').insertAdjacentHTML("beforeend",
  `
  <div class="confirm_order_id">${order.orderNumber}</div>
  <div class="confirm_username">${order.username}</div>
  <div class="confirm_date">${date.getFullYear()+"/"+Number(date.getMonth()+1)}</div>
  <div class="confirm_items">${}</div>
  <div class="confirm_quantity">${}</div>
  <div class="confirm_price">${}</div>
  <div class="confirm_return">${}</div>
  `)
});
