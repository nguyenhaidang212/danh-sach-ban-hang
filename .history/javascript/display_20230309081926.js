...
payment.addEventListener("click", (e) => {
  ...
  <div class="confirm_items">${item.length}</div>
  <div class="confirm_quantity">${quantity}</div>
  ...
  `
    ...
    document.querySelector(".confirm_title").style.display = "block";
    document.querySelector(".confirm_grid").style.display = "none";
  }
});
