        ...
        arr.forEach((e) => {
          document.querySelector(".order-gird").insertAdjacentHTML(
            ...
            `        <span class = "order-item">${e.id}</span class = "order-item"><span class = "order-item">${e.name}</span class = "order-item"
              ><span class = "order-item">Pending</span class = "order-item"><span class = "order-item">total</span class = "order-item"><span class = "order-item">${e.id}</span class = "order-item"
