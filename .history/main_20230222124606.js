...
//-----Total Price-----
function total(value = 0) {
  let total = 0;
  getItemLocalstorage().forEach((e) => {
    total += Number(e.price) * Number(e.soluong);
  });
  // value.parentNode.nextElementSibling.nextElementSibling.textContent =
  //   Number(value.previousElementSibling) *
  //   Number(value.parentNode.nextElementSibling);
  document.querySelector(".bill").textContent = total;
  console.log(value.parentNode.nextElementSibling.nextElementSibling);
  console.log(value.previousElementSibling);
  console.log(value.parentNode.nextElementSibling);
}
//-----Count item-----
