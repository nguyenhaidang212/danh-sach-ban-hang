        ...
        data.forEach((value) => {
          if (
            ...
            <div class="order-detail-list">
              ...
              <i class="fa-sharp fa-solid fa-caret-right show-detail-item"></i></p>
            </div>
              <div id="list-item-order">
                <span id="tensanpham">tensantensanphamtensanphamtensanphamtensanphamtensanphamtensanptensnsatnsantensanphamtnsantnsantensanphamtnsantnsantensanphamtnsantnsantensanphamtnsantnsantensanphamtnsanntensanphamtnsantensanphamtnsantensanphamtnsantensanphamt</span>
                <span id="soluong">soluong</span>
              </div>
          </div>`
            );
          }
