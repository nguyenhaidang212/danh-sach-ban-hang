      ...
      .then((data) => {
        ...
        arr.forEach((e) => {
          document.querySelector(".order-gird").insertAdjacentHTML(
            "beforeend",
            `        <span class = "order-item">${e.id}</span class = "order-item"><span class = "order-item">${e.name}</span class = "order-item"
              ><span class = "order-item">Pending</span class = "order-item"><span class = "order-item">${e.total}$</span class = "order-item"><span class = "order-item">${e.id}</span class = "order-item"
