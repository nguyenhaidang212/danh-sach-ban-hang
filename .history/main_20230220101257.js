...
$.addEventListener("click", (e) => {
  ...
  if (e.target.matches(".item-add")) {
    // console.log(document.querySelector(".confirm-quantily").textContent);
    addItem(e.target);
    countItem();
  }
  //-----Del Item-----
  ...
  if (e.target.matches(".minus-icon")) {
    if (document.querySelector(".buy-quality").textContent == 1) {
      console.log("ok");
    } else {
...
function countItem() {
  ...
  // if (count == 100) {
  //   document.querySelector(".buy_count").style.fontSize = "10px";
  // }
}
//-----Delete item-----
