          ...
          if (
            ...
            <div class="order-detail-list">
              ...
              <div class="list-item-order">
                <span id="tensanpham">${value.name}</span>
                <span id="soluong">${value.id}</span>
              </div>
          </div>`
            );
          }
      ...
      .then((data) => {
        data.forEach((value) => {
          if (value.id == document.querySelector(".madonhang").textContent) {
            template = `<span id="tensanpham">${value.name}</span>
            <span id="soluong">${value.id}</span>`;
            value.order.forEach((e) => {
              document.querySelector(".list-item-order").insertAdjacentHTML(
                "beforeend",
                `<span id="tensanpham">${e.name}</span>
              <span id="soluong">${e.soluong}</span>`
              );
            });
          }
        });
