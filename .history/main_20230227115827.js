...
$.addEventListener("click", (e) => {
          ...
          document.querySelector(".order-menu").insertAdjacentHTML(
            ...
            <div class="order-grid-item order-detail">
              ...
              <div class="order-item">
                <p class ="order-item-phone">${e.phonenumber}</p>
                <p class ="order-item-email">${e.email}</p>
                <p class ="order-item-address">${e.address}</p>
                <p class ="order-item-message">${e.message}</p>
                <span>Order List
                </span>
              </div>
            </div>
  ...
  if (e.target.matches(".show-detail")) {
    ...
    getApi()
      .then((res) => res.json())
      .then((data) => {
        if (data.id == .target.previousElementSibling.previousElementSibling
          .previousElementSibling.previousElementSibling.previousElementSibling) {
            ...
            <p>Số điện thoại</p>
            <p>${document.querySelector(".order-item-phone").textContent}</p>
            <p>Email</p>
            <p>${document.querySelector(".order-item-email").textContent}</p>
            <p>Địa chỉ</p>
            <p>${document.querySelector(".order-item-address").textContent}</p>
            <p>Ghi chú</p>
            <p>${document.querySelector(".order-item-message").textContent}</p>
