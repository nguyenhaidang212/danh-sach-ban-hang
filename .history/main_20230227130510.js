        ...
        data.forEach((value) => {
          if (
            ...
            <div class="order-detail-list">
              ...
              <ul id="list-item-order">
            <li><span>hellohellohellohellohellohellohellohellohellohellohellohellohellohellohellohellohello123123123</span></li><span>100</span>
            <li>hello</li><span></span>
            <li>hello</li><span></span>
            <li>hello</li><span></span>
            <li>hello</li><span></span>
            <li>hello</li><span></span>
