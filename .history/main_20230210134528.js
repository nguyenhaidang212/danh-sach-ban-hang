...
$.addEventListener("click", (e) => {
  ...
  if (e.target.matches(".buy_display")) {
    const listItem = JSON.parse(localStorage.getItem("danhsachmua"));
...
function delItemBuy(name) {
  ...
  console.log(arrayItemAdd);
  // const listItemBuy = JSON.parse(localStorage.getItem("danhsachmua"));
  // listItemBuy.forEach(e => {
